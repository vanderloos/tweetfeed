...
class MyFeed:
	def __init__(self, consumer_key='', consumer_secret='', access_token_key='77175560-', access_token_secret='', xml_out_file = "pyrss2gen.xml"):
	...
	def get_feed(self):
		...
		for f in friends:
			statuses_sum += api.GetUserTimeline(user_id = f.id, since_id = 357931428379500544)
